...
//         s.src = "https://rawgit.com/web-animations/web-animations-js/master/web-animations.min.js";
        s.src = "https://rawgit.com/web-animations/web-animations-js/dev/web-animations.dev.js";
        if (document.head) {
    ...
    DelayedAnimation.prototype.bind = function(type,func,isGlobal){
      ...
      if(this._element && this._bind_type && this._bind_type &&!this._bound){
        if(this._bind_isglobal){this._element.addEventListener(type,this._bound_call);}
        else                   {document.addEventListener(type,this._bound_call);}
        this.play();
      }
    }
    /*-----------------------------------------------------------------------------*\
    ...
    if (needed.length == 0) needed = Object.keys(document.createElement("div").style.__proto__)
    //resume normal general code...
